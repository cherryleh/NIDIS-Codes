    ...
    <div class="content">
        <div class="subcontent">
            ...
            <div id="rain">
                    ...
                    <div class="charts">
                        <div class="map">
                            <img style="width: 100%; vertical-align: middle;" src="./maps/HI/<?php echo $_GET["ranch"]?>_et.png">
                        </div>
                        <div class="graph12m">
            ...
            <div id="rainForecast">
                ...
                <div id="rainProj" class="sec3heading">
                    ...
                    <img src="./graphs/<?php echo $_GET["ranch"]?>_rainfall.png">
                </div>
            </div>
            ...
            <div id="data">
                ...
                <div class="wrapperHist">
                    <div id="rainHist" class="graphHist box">
                        ...
                        <img src=" ./RanchPointsRF/<?php echo $_GET["ranch"]?>_BI/<?php echo $_GET["ranch"]?>_BI_Climograph.png">
                    </div>
                    <span></span>
                    <div id="droughtHist" class="graphHist box">
                        <p class="dataTitles" style="text-align: center"> 100-year Drought History</p>
                        <img src="./RanchPointsRF/<?php echo $_GET["ranch"]?>_BI/<?php echo $_GET["ranch"]?>_BIDrought_History.png">
                    </div>
                </div>
                <div style="text-align: center">
                    <div id="rainTrend" class="box">
                        <p class="dataTitles" >100-year Rainfall Trends</p>
                        <img src="./RanchPointsRF/<?php echo $_GET["ranch"]?>_BI/<?php echo $_GET["ranch"]?>_BI_RF_Trend.png">
                    </div>
                </div>
            </div>
        </div>
