        ...
        <nav class="sidebar py-2 mb-4">
            <ul class="nav flex-column" id="nav_accordion">
                ...
                <li class="nav-item has-submenu">
                    <a style="display:inline-block" class="nav-link" href="#climate-anchor"> Average Climate Conditions <i class="bi bi-caret-down-fill"></i> </a> 
                    <ul class="submenu collapse">
                        <li><a class="nav-link" href="#">Rainfall </a></li>
                        <li><a class="nav-link" href="#">Temperature </a></li>
                        <li><a class="nav-link" href="#">Evapotranspiration</a> </li>
                        <li><a class="nav-link" href="#">NDVI</a> </li>
                    </ul>
                </li>
                <li class="nav-item">
